...
const LatLng SOURCE_LOCATION = LatLng(48.8558, 2.3909);
const LatLng DEST_LOCATION = LatLng(48.8499, 2.3947);
...
// for my drawn routes on the map
  ...
  String googleAPIKey = 'AIzaSyCuLdJLBpaf7jwJA8WoQsvgwPohjAuZAIY';
...
// wrapper around the location API
  ...
  void setSourceAndDestinationIcons() async {
    BitmapDescriptor.fromAssetImage(
            ImageConfiguration(devicePixelRatio: 2.0), 'images/driving_pin.png')
        .then((onValue) {
      sourceIcon = onValue;
    });
